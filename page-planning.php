...
<div class="PageWrapper"> 
	...
	<div class="ContentsArea FadeIn" id="SubMenu">
		<div class="Parts Left SubMenuBtn subMenuClose">
				...
				<div class="content hide">
					<div class="image"><img src="<?php echo get_template_directory_uri(); ?>/image/plan/plan_content_1.jpg"></div>
					<div class="text">
	...
	<div class="ContentsArea" id="member">
			...
			<div class="parts FadeIn">
				<div class="image">
					<img src="<?php echo get_template_directory_uri(); ?>/image/plan/plan_profile.jpg">
				...
				<div class="caption">
					<div class="txt">
						カラープランナー。大学卒業後、インテリア商社勤務。退職後に専門学校で建築、インテリアコーディネートを学ぶ。<br>
						国内、海外旅行で目に触れた建築や景色に心動かされた経験から、空間での色や質感の効果や美しさを表現できる素材に興味を持ち、<br>
						海外のペイント文化に目を向ける。輸入業務を経験、色彩の提案・ペイントの調合から販売、ワークショップ企画、開催を行う。<br>
						<br>
						2007年よりカラープランナーとして活動をスタート。より住空間に寄り添った提案を目指し、2015年から拠点を東京から鎌倉に移す。<br>
						色が持つ力により空間デザインの幅がより広がっていくことに期待し、様々なアプローチで可能性を探る。2018年、COAT COLOR BOOKを発表。レシピ監修を行う。<br>
					</div>
				</div>
			</div>
	</div><!--ContentsArea --> 
